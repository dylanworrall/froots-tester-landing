...
authorRole: "Froots"
category: "Letter"
excerpt: "A reader in Berlin asks whether to rename Froots's built-in agents after his two cats. We have thoughts. Specifically: we have one thought, strongly held."
tags: ["letters", "agents", "naming"]
coverColor: "#F6C849"
---
...
1. They're **distinct enough to remember at a glance** — four fruits, four colors, four roles.
2. They **describe the role without being bossy** — Lime is curious, Yuzu is careful, Clem is eager, Cherry is patient.
3. They're **not tied to anyone's real life**, so the app works the same whether you're the original owner of the vault or the new hire reading someone else's routines.
