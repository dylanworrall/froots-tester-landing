...
// All platforms on v0.2.13 (updater-signed; macOS also Developer-ID-signed +
...
const MAC_DMG = `${DL}/v0.2.13/Froots_0.2.13_aarch64.dmg`;
const WIN_EXE = `${DL}/v0.2.13/Froots_0.2.13_x64-setup.exe`;
const LINUX_APPIMAGE = `${DL}/v0.2.13/Froots_0.2.13_amd64.AppImage`;
