...
// All platforms on v0.2.12 (updater-signed; macOS also Developer-ID-signed +
...
const MAC_DMG = `${DL}/v0.2.12/Froots_0.2.12_aarch64.dmg`;
const WIN_EXE = `${DL}/v0.2.12/Froots_0.2.12_x64-setup.exe`;
const LINUX_APPIMAGE = `${DL}/v0.2.12/Froots_0.2.12_amd64.AppImage`;
